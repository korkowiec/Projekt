...
{
public:
    Przycisk(RenderWindow &W, sf::Event &E, u_short &Zmieniacz, short Stany[6] = 0,
    ...
    Przycisk(RenderWindow &W, sf::Event &E, bool &Zmieniacz, bool Stany[6] = 0,
             sf::Vector2f pos = sf::Vector2f(0, 0),
             sf::Vector2f roz = sf::Vector2f(0, 0),
             std::string S = "",
             sf::Color C = sf::Color::Green
    ...
    Przycisk(RenderWindow &W, sf::Event &E, short &Zmieniacz, short Stany[6] = 0,
             sf::Vector2f pos = sf::Vector2f(0, 0),
             sf::Vector2f roz = sf::Vector2f(0, 0),
             std::string S = "",
             sf::Color C = sf::Color::Green
    ...
    Przycisk(RenderWindow &W, sf::Event &E, u_short &Zmieniacz, u_short Stany[6] = 0,
             sf::Vector2f pos = sf::Vector2f(0, 0),
             sf::Vector2f roz = sf::Vector2f(0, 0),
             std::string S = "",
             sf::Color C = sf::Color::Green
    ...
    Przycisk(RenderWindow &W, sf::Event &E, int &Zmieniacz, int Stany[6] = 0,
             sf::Vector2f pos = sf::Vector2f(0, 0),
             sf::Vector2f roz = sf::Vector2f(0, 0),
             std::string S = "",
             sf::Color C = sf::Color::Green
...
private:
    ...
    // Wskaźniki na wartości, które przycisk ma zmieniać
