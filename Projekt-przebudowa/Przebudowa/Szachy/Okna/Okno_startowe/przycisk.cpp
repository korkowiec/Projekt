#include "Klasy/przycisk.h"


Przycisk::Przycisk(sf::RenderWindow &W,sf::Event &E,
                   u_short &Zmieniacz,u_short Stany[6],
                   sf::Vector2f (pos),
                   sf::Vector2f (roz),sf::Color C)
{
    Zmieniau_short=&Zmieniacz;
    for(u_short c=0;c<6;c++) Ustawu_shortTablica[c]=Stany[c];
    Przycisk_podstawy(W,E,pos,roz,C);
}
Przycisk::Przycisk(sf::RenderWindow &W,sf::Event &E,
...
void Przycisk::Przycisk_podstawy(sf::RenderWindow &W,sf::Event &E,
                   sf::Vector2f (pos),
                   sf::Vector2f (roz),
                   sf::Color C)
{
